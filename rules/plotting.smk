...
rule plot_2030_LCoEs:
    ...
    output:
        figures=multiext("figures/paper-01/LCoE_all-ESC-EXP_{year}_{scenario}", ".pdf", ".png")
    notebook:
        "../actions/plotting/LCoE_all-ESC-EXP.py.ipynb" #TODO

rule plot_2030_to_2050_LCoEs:
    input:
        results=rules.all_scenario_results.output,
    output:
        figures=multiext("figures/paper-01/LCoE_all-ESC-EXP_2030-2050_{scenario}", ".pdf", ".png")
    notebook:
        "../actions/plotting/LCoE_all-ESC-EXP_2030-2050.py.ipynb" #TODO

rule plot_2030_to_2050_LCoHs:
    input:
        results=rules.all_scenario_results.output,
    output:
        figures=multiext("figures/paper-01/LCoH_all-ESC-EXP_2030-2050_{scenario}", ".pdf", ".png")
    notebook:
...
rule plot_selected_ESCs_cost_compositions:
    input:
        results=rules.all_scenario_results.output,
    output:
        figures=multiext("figures/paper-01/cost-compositions_selected_ESCs_{scenario}", ".pdf", ".png")
    notebook:
...
rule plot_sensitivities:
    input:
        results=rules.all_scenario_results.output,
    output:
        figures=multiext("figures/paper-01/sensitivities_{year}_{esc}_ES-DE", ".pdf", ".png")
    notebook:
